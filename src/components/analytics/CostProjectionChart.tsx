...
import {
  ...
  CartesianGrid, Tooltip, Legend, ReferenceArea, ReferenceLine, Brush
} from 'recharts';
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="space-y-2">
            ...
            <Slider
              ...
              onValueChange={(value) => handleFilterChange('alertThreshold', value[0])}
          ...
          <div className="flex items-center space-x-4">
            <Switch
              id="rolling3"
              checked={filters.showRolling3Month}
              onCheckedChange={(checked) => handleFilterChange('showRolling3Month', checked)}
            />
          ...
          <div className="flex items-center space-x-4">
            <Switch
              id="rolling6"
              checked={filters.showRolling6Month}
              onCheckedChange={(checked) => handleFilterChange('showRolling6Month', checked)}
            />
              ...
              >
                ...
                {chartType === 'monthly' && (
                  <>
                      ...
                      if (entry.forecast) {
                        return (
                          <ReferenceArea
                            ...
                            x1={entry.month}
                            x2={entry.month}
                            y1={entry.forecast * 0.95}
                            y2={entry.forecast * 1.05}
                            yAxisId="left"
                            strokeOpacity={0}
                            fill="#C084FC"
                            fillOpacity={0.2}
                    ...
                    {filters.showRolling3Month && (
                      <Line
                        type="monotone"
                        dataKey="rolling3Month"
                        name="3-Month Avg"
                        stroke="#10B981"
                        strokeWidth={2}
                        dot={false}
                    ...
                    {filters.showRolling6Month && (
                      <Line
                        type="monotone"
                        dataKey="rolling6Month"
                        name="6-Month Avg"
                        stroke="#06B6D4"
                        strokeWidth={2}
                        dot={false}
